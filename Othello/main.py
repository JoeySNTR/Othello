...
def point(click):       #fonction lier au click gauche
    global player,matrice,matrice_retour,last_gain,last_pion,label,color,choice,piece_played,cases,piece_gagnee
...
def possibility():          #permet d'afficher les possibilités de jeu
    global cases,matrice,player,piece_gagnee
    ite_ligne,ite_colonne=0,0;
...
def play_PvP():         #met en place le jeu et les pièces de départ
    global matrice,piece_played,player,color,cases,choice
